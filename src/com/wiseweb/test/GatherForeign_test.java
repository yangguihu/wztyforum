 ...
 *
 */
public class GatherForeign_test{
	...
	public static void main(String[] args) throws Exception {
		...
		String ROOT = "/wzty/foreign/";
		String table="foreign_com";
		String dbname="forum1_gather";
		int pagenum=50;  //每次查询的数量
...
//					System.out.println(id);
	...
	public static void handleRs(ResultSet rs,Producer<String,String> producer,
        ...
        crawToKafa(producer,KCConstant.FOREIGN, keyMsg, jsonStr, id, queue);
        //记录采集信息
					...
					new Callback() {
						public void onCompletion(RecordMetadata metadata,Exception e) {
							 if(e != null){
								 //可以在此执行自己的回调逻辑
								 queue.add(id);
								 System.out.println(new Date()+" "+id+" -->消息发送失败");
